        ...
        <div className="container px-5 mx-auto">
          <div className="text-center md:mb-10">
            ...
            <p className="text-lg leading-relaxed xl:w-3/4 lg:w-3/4 mx-auto">
              ...
              stated that the RBI's CBDC, also known as the Digital Rupee or
              e-Rupee, is interchangeable one-to-one at par with the fiat
              currency and is the same as a sovereign currency. Holders of CBDC
              do not need to have a bank account because it is fungible legal
              money.
            </p>
          </div>
            ...
            <div className="p-2 sm:w-1/2 w-full">
              <div className="bg-gray-100 rounded flex p-4 h-full items-center">
                <svg
                  ...
                  strokeWidth="3"
                  className="text-[#009ac9] w-6 h-6 flex-shrink-0 mr-4"
                  viewBox="0 0 24 24"
                >
